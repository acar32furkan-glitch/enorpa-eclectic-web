...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Enorpa Enerji — Endüstriyel Isıtma Sistemleri" },
      { property: "og:description", content: "25+ yıllık deneyimle endüstriyel buhar, sıcak su ve sıcak hava kazanları." },
