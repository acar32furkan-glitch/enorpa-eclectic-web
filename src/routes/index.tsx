...
const DOCS: Doc[] = [
  ...
  },
  {
    ...
    size: "888 KB",
    gated: false,
    url: "/docs/oniks-serisi.pdf",
  },
  {
    id: "akuamarin-spec",
    title: "Akuamarin Serisi Teknik Föy",
    sub: "PDF · Sıcak Su Kazanları",
    size: "811 KB",
    gated: false,
    url: "/docs/akuamarin-serisi.pdf",
  },
  {
    id: "turkuaz-spec",
    title: "Turkuaz Serisi Teknik Föy",
    sub: "PDF · Sıcak Su Kazanları",
    size: "602 KB",
    gated: false,
    url: "/docs/turkuaz-serisi.pdf",
  },
  {
    id: "has-spec",
    title: "HAS Serisi Teknik Föy",
    sub: "PDF · Sıcak Hava Sistemleri",
    size: "853 KB",
    gated: false,
    url: "/docs/has-serisi.pdf",
  },
  {
    id: "has-ng-spec",
    title: "HAS NG Serisi Teknik Föy",
    sub: "PDF · Sıcak Hava Sistemleri",
    size: "604 KB",
    gated: false,
    url: "/docs/has-ng-serisi.pdf",
  },
  {
    id: "has-turbo-spec",
    title: "HAS Turbo Serisi Teknik Föy",
    sub: "PDF · Sıcak Hava Sistemleri",
    size: "712 KB",
    gated: false,
    url: "/docs/has-turbo-serisi.pdf",
  },
];
